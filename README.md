...
img {
   ...
   * [Android学习笔记](#android学习笔记)
      ...
      * [Fragment相关](#fragment相关)
         ...
         * [Activoty与Fragment的通信方式](#activoty与fragment的通信方式)
      * [Service相关](#service相关)
      * [View相关](#view相关)
      * [虚拟机相关](#虚拟机相关)
         * [方法64K的限制](#方法64k的限制)
         * [JVM GC算法](#jvm-gc算法)
            * [标记回收算法(Mark and Sweep)](#标记回收算法mark-and-sweep)
            * [复制(Copying)](#复制copying)
            * [标记压缩(Mark-Compat)](#标记压缩mark-compat)
            * [分代](#分代)
      * [Android多中的多线程](#android多中的多线程)
      * [动画](#动画)
      * [图片加载相关](#图片加载相关)
      * [序列化](#序列化)
      * [各版本新特性](#各版本新特性)
         * [Android 5.0(Lollipop)](#android-50lollipop)
         * [Android 6.0(Mushroom)](#android-60mushroom)
         * [Andorid 7.0(Nougat)](#andorid-70nougat)
         * [Android 8.0(Oreo)](#android-80oreo)
         * [Android 9.0(Pie)](#android-90pie)
      * [常用框架原理](#常用框架原理)
      * [性能相关](#性能相关)
         * [Android内存泄漏](#android内存泄漏)
            * [概念](#概念)
            * [常见的内存泄漏](#常见的内存泄漏)
            * [检查内存泄漏的方法](#检查内存泄漏的方法)
      * [其他](#其他)
         * [Android中对集合的优化](#android中对集合的优化)
...
- [隐式Intent匹配](./Android/Activity相关.md)
- [Activity的启动模式](./Android/Activity相关.md)
- [理解Activity，View，Window三者关系](./Activity, Window和View之间的关系.md)
